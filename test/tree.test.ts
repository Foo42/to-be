  ...
  describe('summarising', () => {
    describe('SummariseDueDates', () => {
      it('should return an empty list for a tree with no children and no due date', () => {
        const todo: Todo = { id: 'a', title: 'a', complete: false, createdAt: new Date(), contexts: [], tags: [] }
      ...
      it('root summary should only include due date of root for a tree with no children', () => {
        ...
        const todo: Todo = { id: 'a', title: 'a', complete: false, createdAt: new Date(), contexts: [], tags: [], dueDate }
        const tree = buildTodoTree([todo])[0]
        const summarisedTree = SummariseDueDates(tree)
      ...
      it('root summary should include due dates of children for a root with children', () => {
        const dueDate = new Date('2050-01-15')
        const todos = [
          { id: 'a', title: 'I am a parent', complete: false, createdAt: new Date(), contexts: [], tags: [], dueDate: new Date('2050-01-15') },
          { id: 'b', title: 'I am a child', parentTaskId: 'a', complete: false, createdAt: new Date(), contexts: [], tags: [], dueDate: new Date('2060-02-16') },
          { id: 'c', title: 'I am another child', parentTaskId: 'a', complete: false, createdAt: new Date(), contexts: [], tags: [], dueDate: new Date('2070-03-17') },
          { id: 'd', title: 'child without due date', parentTaskId: 'a', complete: false, createdAt: new Date(), contexts: [], tags: [] }
        ]
      ...
      it('root summary should include due dates of all decendent children', () => {
        ...
        const todos = [
          { id: 'a', title: 'I am a parent', complete: false, createdAt: new Date(), contexts: [], tags: [], dueDate: new Date('2050-01-15') },
          { id: 'b', title: 'I am a child', parentTaskId: 'a', complete: false, createdAt: new Date(), contexts: [], tags: [], dueDate: new Date('2060-02-16') },
          { id: 'c', title: 'I am a grandchild', parentTaskId: 'b', complete: false, createdAt: new Date(), contexts: [], tags: [], dueDate: new Date('2070-03-17') },
          { id: 'd', title: 'I am a great grandchild', parentTaskId: 'c', complete: false, createdAt: new Date(), contexts: [], tags: [], dueDate: new Date('2080-04-18') },
          { id: 'd', title: 'I am a great grandchild', parentTaskId: 'c', complete: false, createdAt: new Date(), contexts: [], tags: [], dueDate: new Date('2090-05-19') }
        ]
        const tree = buildTodoTree(todos)[0]
        const summarisedTree = SummariseDueDates(tree)
